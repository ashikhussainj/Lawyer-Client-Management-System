...
<!--                                                        <small>Last seen: 2 hours ago</small>-->
                                                ...
                                                <div class="col-lg-6 hidden-sm text-right">
                                                    <form action="Chatmainupload2" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="chat-history ashok-scroll" style="overflow-x: scroll;height: 241px" >
                                            <ul class="m-b-0">
                                                ...
                                                <%
                                                    ...
                                                    try {
                                                        PreparedStatement st = con.prepareStatement("select * from chats where (fromemail=? and toemail=?) or (fromemail=? and toemail=?) ");
                                                        ...
                                                        while (rs.next()) {
                                                            ...
                                                            if (rs.getString("fromemail").equals(email)) {
                                                                if (rs.getInt("img") == 1) {
                                                %>
                                                ...
                                                <li class="clearfix">
                                                    ...
                                                    <a class="float-right message other-message" href="Chatimages/<%=rs.getString("content")%>" target="_blank">
                                                        <img src="Chatimages/<%=rs.getString("content")%>" class=" d-flex justify-content-center" style="width: 50px;height: 50px">
                                                    </a>
                                                </li>
                                                ...
                                                <li class="clearfix">
                                                    ...
                                                    <a class=" message my-message" href="Chatimages/<%=rs.getString("content")%>" target="_blank">
                                                        <img src="Chatimages/<%=rs.getString("content")%>" class=" d-flex justify-content-center" style="width: 50px;height: 50px">
                                                    </a>                                  
                                                </li> 
                                        ...
                                        <div class="chat-message clearfix">
                                            <div class="input-group mb-0">
                                                <form action="CLient_message.jsp" method="Post">
...
// Add an event listener to the file input to handle when a file is selected
    ...
    <script>
        ...
        function sendValueToServlet() {
            ...
            // Create a URL for your servlet
            var servletUrl = "YourServletURL"; // Replace with the actual URL of your servlet
            ...
            // Send the value to the servlet using a POST request
            fetch(servletUrl, {
                method: "POST",
                headers: {
                ...
                body: JSON.stringify(data)
                    ...
                    .then(response => {
                        ...
                        if (response.ok) {
                            ...
                            outputvalue.innerHTML = inputname;

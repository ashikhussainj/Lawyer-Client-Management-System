                        ...
                        <table class="table">
                            ...
                            <tbody> 
                                <%
                                    ...
                                    try {
                                        PreparedStatement st = con.prepareStatement("select * from acceptemail where toemail=? and flag=?");
                                ...
                                <tr>
                                    ...
                                    <td><a href="LawyerRequest.jsp?fromemail=<%=rs.getString("fromemail")%>&toemail=<%=rs.getString("toemail")%>" class="btn btn-primary" >Accept</a></td>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a href="LawyerRequest.jsp?fromemail=<%=rs.getString("fromemail")%>&toemail=<%=rs.getString("toemail")%>" class="btn btn-primary">Accept</a>

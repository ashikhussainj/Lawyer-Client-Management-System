...
<!--                                                        <small>Last seen: 2 hours ago</small>-->
                                                ...
                                                <div class="col-lg-6 hidden-sm text-right">
                                                    ...
                                                    <form action="Chatimageupload" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="chat-history ashok-scroll" style="overflow-x: scroll;height: 241px" >
                                            <ul class="m-b-0">
                                                ...
                                                <%}
                                                    ...
                                                    if (rs.getString("fromemail").equals(Clientemail)) {
                                                        if (rs.getInt("img") == 1) {
                                        ...
                                        <div class="chat-message clearfix">
                                            <div class="input-group mb-0">
                                                <form action="Lawyer_message.jsp" method="Post">

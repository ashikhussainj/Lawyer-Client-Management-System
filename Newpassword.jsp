                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-md-6 col-lg-5">
                                                        <div class="login-wrap p-4 p-md-5" >
                                                            ...
                                                            <form action="newpassword" class="login-form" method="Post">
                                                                <div class="form-group">
                                                                    <input type="hidden" class="form-control rounded-left" value="<%=session.getAttribute("verifyemail")  %>" name="email" >
                                                                </div>
                                                                <div class="form-group d-flex">
                                                                    <input type="password" class="form-control rounded-left" placeholder="New Password" name="pass1" required>
                                                                </div>
                                                                  <div class="form-group d-flex">
                                                                    <input type="password" class="form-control rounded-left" placeholder="New Password" name="pass2" required>
                                                                </div>

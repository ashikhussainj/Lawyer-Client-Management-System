            ...
            <header class="header_section">
                <div class="container-fluid">
                    ...
                    <%
                       ...
                       String email=request.getParameter("lawyeremail");
                    %>

                    <div style="" class="d-flex justify-content-center">
                        <form action="Addreview.jsp" method="post" style="width: 55%;margin-top: 30px;background-color: white;border-radius: 10px"  >
                            ...
                            <div class="form-group" style="margin-left: 20px;margin-right: 20px">
                                ...
                                <input type="text" name="review" class="form-control" id="exampleFormControlInput1" >
                            </div>

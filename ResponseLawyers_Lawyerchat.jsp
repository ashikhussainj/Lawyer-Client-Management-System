                            ...
                            <div class="col-lg-12">
                                <div class="card chat-app">
                                    ...
                                    <%
                                        ...
                                        String Clientname = "" + session.getAttribute("Clientname");
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="chat-about">
                                                        <h6 class="m-b-0" id="outputvalue"><%=Clientname%></h6>
<!--                                                        <small>Last seen: 2 hours ago</small>-->
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 hidden-sm text-right">
                                                    <form action="ResponseLawyers_Lawyerchat" method="post" enctype="multipart/form-data"> <i class="fa fa-image btn btn-outline-info" id="file-picker-icon"></i>
                                                        <!--                                                    </a>-->
                                            ...
                                            <ul class="m-b-0">
                                               ...
                                               if (rs.getInt("img") == 1) {
                                                ...
                                                <li class="clearfix">
                                                    ...
                                                    <a class="float-right message other-message" href="RespoonseLawyers_Lawyerchat/<%=rs.getString("content")%>" target="_blank">
                                                ...
                                                <li class="clearfix">
                                                    ...
                                                    <a class=" message my-message" href="ResponseLawyerchatimages/<%=rs.getString("content")%>" target="_blank">
                                        ...
                                        <div class="chat-message clearfix">
                                            <div class="input-group mb-0">
                                                <form action="Responselawyers_Lawyer_message.jsp" method="Post">

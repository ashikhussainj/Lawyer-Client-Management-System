...
<!--                                        <img src="images/user.png" alt="">-->
                ...
                <div class="container bg-white" style="width: 800px;height: 500px; overflow-y: scroll;margin-top: -18px">
                    <table class="table"  >
                        <thead>
                            <tr>
                        ...
                        <tbody  > 
                            ...
                            <tr style="">
                                ...
                                <td>
                                    <a href="Files/<%=rs.getString("filename")%>" target="_blank">
                                        <img src="Files/<%=rs.getString("filename")%>" class=" d-flex justify-content-center" style="width: 50px;height: 50px">
                                    </a>
                                ...
                                <td>
                                    ...
                                    <%
                                        PreparedStatement st1 = con.prepareStatement("select * from postresponse where fromemail=? and postid=?");
                                        st1.setString(1, "" + session.getAttribute("email"));
                                    ...
                                    <a href="Send_Response.jsp?email=<%=rs.getString("email")%>&id=<%=rs.getString("id")%>" class="btn btn-primary" >Accept</a>

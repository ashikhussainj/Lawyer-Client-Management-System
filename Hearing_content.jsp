            ...
            <header class="header_section">
                <div class="container-fluid">
                    ...
                    <div style="" class="d-flex justify-content-center">
                        <form action="Add_Hearing_Description" method="post"  style="width: 55%;margin-top: 30px;background-color: white;border-radius: 10px"  >
                            <div class="form-group" style="margin-left: 20px;margin-right: 20px;margin-top: 30px    ">
                                <label for="exampleFormControlInput1">Email address</label>
                                <input type="email" name="email" value="<%=email%>" readonly="" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                            </div>
                            ...
                            <div class="form-group" style="margin-left: 20px;margin-right: 20px">
                                ...
                                <!--                                <input type="text" name="description" class="form-control" id="exampleFormControlInput1" >-->
                                <select class="form-control" name="hearingtype" aria-label="Default select example">
                            ...
                            <div class="form-group" style="margin-left: 20px;margin-right: 20px">
                                ...
                                <input type="email" name="clientemail" class="form-control" id="exampleFormControlInput1" >
                            </div>
                            <div class="form-group" style="margin-left: 20px;margin-right: 20px">
                                <label for="exampleFormControlInput1">Hearing Date</label>
                                <input type="date" name="hearingdate" class="form-control" id="exampleFormControlInput1" >
                            </div>

                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <%
                                    ...
                                    try {
                                        PreparedStatement st = con.prepareStatement("select * from postresponse where fromemail=? ");
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <a href="postresponselawyer_session.jsp?toemail=<%=rs.getString("toemail")%>" class="btn btn-primary" >Chat</a>
                                    </td>

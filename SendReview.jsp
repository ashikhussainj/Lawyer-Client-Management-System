                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <%
                                    ...
                                    try {
                                        PreparedStatement st = con1.prepareStatement("select * from acceptemail where fromemail=? and flag=?");
                                ...
                                <tr>
                                    ...
                                    <td><%=rss.getString("UPPER(username)")%></td>
                                    <td><%=rss.getString("UPPER(category)")%></td>
                                    <td><%=rss.getString("email")%></td>
                                    <td>
                                        <a class="btn btn-primary" href="send_lawyerreview.jsp?lawyeremail=<%=rss.getString("email")%>">Send Review</a>
                                    </td>

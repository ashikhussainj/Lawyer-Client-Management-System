...
<!--                                <ul class="navbar-nav  ">
                    ...
                    <div style="" class="d-flex justify-content-center">
                        <form action="Uploadbarcouncil" method="post" enctype="multipart/form-data" style="width: 55%;margin-top: 30px;background-color: white;border-radius: 10px"  >
                           
                            <div class="form-group" style="margin-left: 20px;margin-right: 20px">
                                <label for="exampleFormControlInput1">Bar council Image</label>

...
<html>
    ...
    <body>
        <%
            ...
            String Lawyeremail = request.getParameter("fromemail");
...
//            String lawyername = request.getParameter("name");
            ...
            session.setAttribute("lawyername", rs1.getString("username"));
          
            response.sendRedirect("Response_Lawyerchat.jsp");
            }
